...
| 관심사 | 파일 |
|---|---|
| public scheduler API | `os/include/sched.h` |
| TCB, task state, task group | `os/include/tinyara/sched.h` |
...
| pending release | `os/kernel/sched/sched_mergepending.c` |
| preemption lock | `os/kernel/sched/sched_lock.c`, `os/kernel/sched/sched_unlock.c` |
...
| yield | `os/kernel/sched/sched_yield.c` |
| timer tick / RR | `os/kernel/sched/sched_processtimer.c`, `os/kernel/sched/sched_timerexpiration.c` |
| PID to TCB lookup | `os/kernel/sched/sched_gettcb.c` |
...
- semaphore: `g_waitingforsemaphore`
- signal: `g_waitingforsignal`
- message queue: `g_waitingformqnotempty`, `g_waitingformqnotfull`
- FIN: `g_waitingforfin`
- page fill: `g_waitingforfill`
...
| 바꾸려는 동작 | 먼저 볼 위치 |
|---|---|
| priority ordering | `sched_addprioritized.c`, `sched_setpriority.c` |
...
| RR time slice | `sched_processtimer.c`, `sched_timerexpiration.c`, `sched_setscheduler.c` |
| priority inheritance | `os/kernel/semaphore/sem_wait.c`, `os/kernel/semaphore/sem_post.c`, `os/kernel/semaphore/sem_holder.c`, `sched_reprioritize.c` |
