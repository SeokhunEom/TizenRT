...
| 이름 | 위치 | 의미 |
|---|---|---|
| `struct posix_timer_s` | `os/kernel/timer/timer.h:85` | POSIX timer instance |
| `pt_owner` | `os/kernel/timer/timer.h:91` | signal을 받을 owner pid |
| `pt_delay` | `os/kernel/timer/timer.h:92` | periodic interval tick delay |
...
| `g_freetimers` | `os/kernel/timer/timer_initialize.c:90` | preallocated timer free list |
...
| `irq_unexpected_isr` | `os/kernel/irq/irq_unexpectedisr.c:98` | default/unregistered interrupt handler |
