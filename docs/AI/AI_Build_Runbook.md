...
- 문서/QEMU checkout HEAD: `6bc776670867d6ad39e8393f839d0589c783c788`
...
QEMU `hello`와 TASH/`kernel_tc`는 [Mac QEMU ARMv8-M 가이드](Mac_QEMU_ARMv8M_TASH_KernelTC.md)의 runner를 사용한다. 이 결과는 QEMU 실행과 kernel test protocol의 증거이며, 대표 보드의 하드웨어 동작을 대신하지 않는다.
