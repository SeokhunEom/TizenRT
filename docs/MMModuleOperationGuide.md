...
- [Runtime Heap Topology](#runtime-heap-topology)
- [Boot-Time Initialization](#boot-time-initialization)
- [Core Allocator Data Structures](#core-allocator-data-structures)
- [Allocation Path](#allocation-path)
- [Free Path](#free-path)
- [KMM and UMM Wrappers](#kmm-and-umm-wrappers)
- [Loadable App Heap Flow](#loadable-app-heap-flow)
- [Debug and Failure Handling](#debug-and-failure-handling)
...
## Core Allocator Data Structures
