...
root=pathlib.Path('/Volumes/T7/Dev/TizenRT/codex/qemu-armv8m-kernel-tc');e=pathlib.Path('/private/tmp/hm-armv8m-fault-message-whudzy7n');out=e/args.name;out.mkdir()
