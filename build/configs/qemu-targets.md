...
boots with QEMU's `mps2-an505` Cortex-M33 machine:
...
packages in the emulated memory map:

- `app1` at `0x10300000` for `loadable_all` and `loadable_apps`
- `common` at `0x102c0000` and `app1` at `0x10360000` for `xip_all`
